...
func registerWriteModifyTools(s *server.MCPServer, node *Node) {
	...
	s.AddTool(mcp.NewTool("set_auto_layout",
		...
		enumStringParam("layoutMode", "Auto-layout direction: HORIZONTAL, VERTICAL, GRID, or NONE. GRID = CSS-grid layout (use gridRowCount/gridColumnCount/gridRowGap/gridColumnGap).", layoutModeEnum),
		...
		enumStringParam("primaryAxisAlignItems", "Main-axis alignment: MIN, CENTER, MAX, or SPACE_BETWEEN", primaryAxisAlignItemsEnum),
		enumStringParam("counterAxisAlignItems", "Cross-axis alignment: MIN, CENTER, MAX, or BASELINE", counterAxisAlignItemsEnum),
		enumStringParam("primaryAxisSizingMode", "Main-axis sizing: FIXED or AUTO (hug)", axisSizingModeEnum),
		enumStringParam("counterAxisSizingMode", "Cross-axis sizing: FIXED or AUTO (hug)", axisSizingModeEnum),
		enumStringParam("layoutWrap", "Wrap behaviour: NO_WRAP or WRAP", layoutWrapEnum),
		...
		enumStringParam("counterAxisAlignContent", "Wrapped-track distribution: AUTO or SPACE_BETWEEN (only when layoutWrap is WRAP)", counterAxisAlignContentEnum),
		...
		enumStringParam("overflowDirection", "Scroll overflow: NONE, HORIZONTAL, VERTICAL, or BOTH", overflowDirectionEnum),
