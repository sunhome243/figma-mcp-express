...
func registerLibraryTools(s *server.MCPServer, node *Node) {
	...
	s.AddTool(mcp.NewTool("create_instance",
		...
		enumStringParam("layoutSizingHorizontal", "Horizontal sizing inside an auto-layout parent: FIXED, HUG, or FILL (set after appendChild)", layoutSizingEnum),
		enumStringParam("layoutSizingVertical", "Vertical sizing inside an auto-layout parent: FIXED, HUG, or FILL (set after appendChild)", layoutSizingEnum),
